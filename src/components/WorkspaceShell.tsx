...
const SLIDES = [
  { c: "#ef5a35", t: "설문 한 번이면 전략까지", d: "사람·계정·톤·금지표현을 받아 계정에 맞는 전략과 주제를 제안해요." },
  { c: "#1f6f63", t: "AI 기획 → 제작 → 검수", d: "주제를 고르면 카드뉴스 초안이 한 번에. 발행 전 검수 게이트는 필수예요." },
  { c: "#d99413", t: "발행은 내가, 성장은 함께", d: "최종 승인·발행은 언제나 나. 칸반·챌린지로 꾸준함을 이어가요." },
];
